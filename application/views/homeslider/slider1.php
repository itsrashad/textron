...
<section class="slider">
    <div class="flexslider">
        <ul class="slides">
            <li>
                <img style="width:50%;float:left;" src="<?php echo base_url(); ?>img/dashboard.png" />
                <div style="width:50%;float:right;padding:5%;">
            ...
            <li>
                <img style="width:50%;float:right;" src="<?php echo base_url(); ?>img/dev-plan.png" />
            ...
            <li>
                <img style="width:50%;float:left;" src="<?php echo base_url(); ?>img/honeycomb.png" />
                <div style="width:50%;float:right;padding:5%;">
            ...
            <li>
                <img style="width:50%;float:right;" src="<?php echo base_url(); ?>img/assessment.png" />
                <div style="width:50%;float:left;padding:5%;">
